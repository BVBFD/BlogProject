...
const NodeJs = ({
  ...
  const backFixUpdate = (event) => {
    ...
    const prevContents = document.querySelectorAll(".nodeJs_switchBox__1f64h");
    ...
    <>
        ...
        <div ref={dataBoxForFixRef} className={styles.dataBoxForFix}>
          ...
          <form className={styles.writeForm}>
            ...
            <CKEditor
              ...
              ref={fixTxtAreaRef}
              data={nodeJSs[keyValue - 1]?.contents}
      ...
      {Object.keys(nodeJSs)
        ...
        .map((key) => {
          ...
          const dbImg = nodeJSs[key].image;
          const dbVideo = nodeJSs[key].video;
          let codes = `
              <div>
